...
export function InvitoForm({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await registraDaInvito(token, {
      nome: fields.nome,
      cognome: fields.cognome,
      ragioneSociale: fields.ragioneSociale,
      partitaIva: fields.partitaIva,
      specializzazione,
      telefono,
      via: fields.via,
    ...
    return (
      <div className="rounded-lg bg-gray-50 px-4 py-6 text-center">
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors disabled:opacity-50"
        >
